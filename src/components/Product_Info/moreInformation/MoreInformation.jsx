...
const MoreInformation = () => {
  ...
  return (
    <div
      className={`col-span-1 md:col-span-3 relative transition-all duration-500 ease-in-out overflow-hidden ${
        showMore ? "max-h-auto h-full" : "max-h-[220px] h-[220px]"
      }`}
    >
      <span className="flex">
        <h1 className="p-2 flex justify-center rounded-2xl font-bold text-4xl bg-gray-950/10 w-[200px]">
          مشخصات بیشتر
        </h1>
        <button
      ...
      {information !== null && (
        <>
          {information.map((item) => {
            ...
            return (
              <span className="flex w-[full] border border-gray-950/10 p-2">
