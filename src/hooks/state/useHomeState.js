...
const useHomeState = () => {
  ...
  return {
    ...
    incredible: {
      ...
      products: state.incredible.products?.filter(
    ...
    bestSelling: {
      ...
      products: state.bestSelling.products?.filter(
        (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
      ),
      pager: state.bestSelling.pager,
    },
    // popularBrands: state.popularBrands?.filter(
    //   (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
    // ),
    categories: state.categories?.filter(
      (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
    ),
    recommendationSubCategories: state.recommendationSubCategories?.filter(
      (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
    ),
    // mobile: {
    ...
    //   products: state.mobile.products?.filter(
    //     (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
    //   ),
    ...
    //   products: state.laptop.products?.filter(
    //     (v, i, a) => a.findIndex((v2) => v2.id === v.id) === i
    //   ),
